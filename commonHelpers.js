import{S as h,i as m,a as f}from"./assets/vendor-89feecc5.js";(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?t.credentials="include":e.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();const y=document.querySelector(".form"),c=document.querySelector(".gallery"),u=document.querySelector(".loader"),n=document.querySelector(".btn-load-more");document.querySelector(".gallery img");n.style.display="none";u.style.display="none";let i=1,d=0;const g=new h(".gallery a",{captionDelay:250,captionsData:"alt"});y.addEventListener("submit",async o=>{o.preventDefault();const l=o.currentTarget.elements.query.value.trim();i=1;try{const{hits:s,totalHits:r}=await p(l,i);if(s.length===0){c.innerHTML="",m.error({position:"topRight",message:"Sorry, there are no images matching your search query. Please try again!"});return}c.innerHTML="";const e=s.map(a=>`<li class="gallery-item">
